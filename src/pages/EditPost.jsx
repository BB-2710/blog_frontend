...
export default function EditPost() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-12 p-8 bg-white border border-slate-200 rounded-2xl">
      <h2 className="text-2xl font-bold text-slate-800 mb-6">Edit Article</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="bg-indigo-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-indigo-700 transition-colors">Save Changes</button>
      </form>
    </div>
  );
}